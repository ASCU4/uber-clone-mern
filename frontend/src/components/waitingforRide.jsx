    ...
    return(
        <div>
            ...
            <div className='flex items-center justify-between'>
                <img className='h-20 w-32 object-contain translate-x-4' src={props.selectedVehicle.image} alt={props.selectedVehicle.alt} />
                <div className='text-right'>
                    ...
                    <p className='mt-2 text-sm font-semibold text-gray-800'>
                        OTP: <span className='text-lg tracking-widest'>{props.otp}</span>
                    </p>
                </div>
            </div>
